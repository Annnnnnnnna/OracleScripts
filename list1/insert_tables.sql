...
ALTER TABLE Bandy DISABLE CONSTRAINT do_bn_re;
...
ALTER TABLE Kocury DISABLE CONSTRAINT do_koc_re;
...
ALTER TABLE Kocury ENABLE CONSTRAINT do_koc_re;
ALTER TABLE Bandy ENABLE CONSTRAINT do_bn_re;
